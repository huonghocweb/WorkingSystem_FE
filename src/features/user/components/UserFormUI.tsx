  ...
  return (
    <>
      <div className="page-wrapper">
        {(isPendingCreate || isPendingUpdate) && <PendingPage />}
                ...
                <section className="settings-section">
                  <div className="card avatar-card">
                    ...
                    <div className="avatar-container">
                      <img src={preview || "/default-avatar.png"} className="profile-preview" />
              ...
              <div className="col-lg-9">
                <section className="settings-section">
                  <div className="card">
                    ...
                    >
                      <div className="form-group" style={{ marginBottom: 0 }}>
                        ...
                        <input type="date" {...register("birthDay")} className="form-input" />
                      ...
                      <div className="role-checklist-container">
                        {roles?.map((role) => (
                          <label key={role.roleId} className="role-checkbox-item">
                            <input type="checkbox" {...register("roleIds")} value={role.roleId} />
                            <span className="role-name">{role.roleName}</span>
                          </label>
                        ))}
                      </div>
                      {errors.roleIds && <span className="error-message">{errors.roleIds.message} </span>}
                    </div>
                  ...
                  <div style={{ marginTop: "1.25rem" }}>
                    <button type="submit" className="btn btn-primary" disabled={isPendingCreate || isPendingUpdate}>
