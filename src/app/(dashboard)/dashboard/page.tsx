      ...
      <div className="app-container">
        ...
        <main className="main-content">
          <div className="page-header">
            <h1 className="greeting" id="greeting">Good morning, Alex</h1>
          ...
          <div className="stats-grid">
            <div className="stat-card">
              ...
              <div className="stat-value">$48,250</div>
                ...
                <div className="activity-feed">
                  <div className="activity-item">
                    ...
                    <div className="activity-content">
                      <p className="activity-text"><strong>Sarah Chen</strong> uploaded new design files for Dashboard v2</p>
                  ...
                  <div className="activity-item">
                    ...
                    <div className="activity-content">
                      <p className="activity-text"><strong>Michael Torres</strong> completed task </p>
                  ...
                  <div className="activity-item">
                    ...
                    <div className="activity-content">
                      <p className="activity-text"><strong>Emma Wilson</strong> commented on your project proposal</p>
                  ...
                  <div className="activity-item">
                    ...
                    <div className="activity-content">
                      <p className="activity-text"><strong>James Lee</strong> joined the team as Frontend Developer</p>
                  ...
                  <div className="activity-item">
                    ...
                    <div className="activity-content">
                      <p className="activity-text">Scheduled deployment for <strong>v2.4.0</strong> completed successfully</p>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>5m 24s</td>
          <td>24.5%</td>
          <td><span className="badge badge-green">+12.4%</span></td>
        </tr>
        <tr>
          <td>
          ...
          <td>4m 18s</td>
          <td>28.3%</td>
          <td><span className="badge badge-green">+8.7%</span></td>
        </tr>
        <tr>
          <td>
          ...
          <td>3m 52s</td>
          <td>31.2%</td>
          <td><span className="badge badge-green">+5.2%</span></td>
        </tr>
        <tr>
          <td>
          ...
          <td>2m 45s</td>
          <td>45.8%</td>
          <td><span className="badge badge-red">-2.3%</span></td>
        </tr>
        <tr>
          <td>
          ...
          <td>6m 12s</td>
          <td>18.4%</td>
          <td><span className="badge badge-green">+15.8%</span></td>
        </tr>
      </tbody>
    </table>
  </div>
                    ...
                    <div className="bar-chart">
                      ...
                      {[1, 2, 3, 4, 5, 6, 7, 8].map((week) => (
                        <div key={week} className="bar-group">
                          <div className="bar-wrapper">
                            <div className="bar" style={{ height: `${60 + week * 10}px`, background: "var(--success)" }}></div>
                    ...
                    {[
                      ...
                      <div key={i} style={{ marginBottom: "1.5rem" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.5rem" }}>
                          ...
                          <span style={{ fontSize: "0.875rem", fontWeight: "600", color: `var(--${m.type})` }}>{m.val}</span>
                        </div>
