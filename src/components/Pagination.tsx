...
const PaginationControls = ({ paginationState, handlePaginationChange, sortOptions }: PaginationProps) => {
  return (
    <div className="pagination-controls">
      <div className="pagination-navigation">
        <button onClick={() => handlePaginationChange("page", 0)}>
        ...
        <span>
          Page {paginationState.page + 1} / {paginationState.totalPages}
        </span>
        <button
          onClick={() => handlePaginationChange("page", paginationState.page + 1)}
        ...
        <button onClick={() => handlePaginationChange("page", paginationState.totalPages - 1)}>
